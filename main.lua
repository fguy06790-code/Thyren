...
local uiName = "Thyren_Pro_PDF_Exact"
...
-- =============================================================================
-- THYREN PRO ELITE (PART 2 OF 2) - ABSOLUTE PDF REPRODUCTION
-- =============================================================================
...
-- [[ THE MAIN CONTAINER - PDF COLOR REPRODUCTION ]]
...
-- [[ SIDEBAR - PDF COLOR REPRODUCTION ]]
...
local SubHeader = Instance.new("TextLabel", Sidebar); SubHeader.Size = UDim2.new(1, 0, 0, 40); SubHeader.Text = "PRO"; SubHeader.TextColor3 = Color3.fromRGB(0, 0, 0); SubHeader.BackgroundTransparency = 1; SubHeader.Font = Enum.Font.Michroma; SubHeader.TextSize = 30; SubHeader.Position = UDim2.new(0,0,0,75)
...
-- [[ PAGE 1: MACRO ENGINE (PDF REPRODUCTION) ]]
local MTitle = Instance.new("TextLabel", MacroP); MTitle.Size = UDim2.new(1, 0, 0, 40); MTitle.Text = "MACRO ENGINE"; MTitle.TextColor3 = Color3.fromRGB(0,0,0); MTitle.BackgroundTransparency = 1; MTitle.Font = Enum.Font.Michroma; MTitle.TextSize = 26; MTitle.TextXAlignment = Enum.TextXAlignment.Left; MTitle.Position = UDim2.new(0,5,0,5)
local MLine = Instance.new("Frame", MacroP); MLine.Size = UDim2.new(1.05, 0, 0, 2); MLine.Position = UDim2.new(-0.05,0,0,55); MLine.BackgroundColor3 = Color3.fromRGB(45,45,45); MLine.BorderSizePixel = 0
...
local PLine = Instance.new("Frame", ParryP); PLine.Size = UDim2.new(1.05, 0, 0, 2); PLine.Position = UDim2.new(-0.05,0,0,55); PLine.BackgroundColor3 = Color3.fromRGB(45,45,45); PLine.BorderSizePixel = 0
...
local PSwFrame = Instance.new("Frame", ParryP); PSwFrame.Size = UDim2.new(0, 70, 0, 34); PSwFrame.Position = UDim2.new(0.8, -5, 0.38, 0); PSwFrame.BackgroundColor3 = Color3.fromRGB(150,150,150); Instance.new("UICorner", PSwFrame).CornerRadius = UDim.new(1,0)
...
local Act = Instance.new("TextButton", ScreenGui); Act.Size = UDim2.new(0, 200, 0, 80); Act.Position = UDim2.new(0.5, -100, 0.8, 0); Act.BackgroundColor3 = Color3.fromRGB(255, 255, 255); Act.BackgroundTransparency = 0.93; Act.Text = "ACTIVATE"; Act.TextColor3 = Color3.fromRGB(255, 255, 255); Act.Font = Enum.Font.Michroma; Act.TextSize = 22; Act.Visible = false; Instance.new("UICorner", Act).CornerRadius = UDim.new(0, 24); MakeDraggable(Act)
...
Submit.MouseButton1Click:Connect(function()
    if IsKeyValid(KeyInput.Text) then
        Auth.Visible = false; Act.Visible = true; UpdateUI()
